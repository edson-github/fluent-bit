...
def flatten_args_list(l):
        return None if l is None else [x for y in l for x in y]
...
if __name__ == "__main__":
    ...
    '''
        ...
        if binary_path is None:
                binary_path = os.path.abspath(f'{dirname}/../..')

        print(f"checking execution binary path: {binary_path}")
        ...
        print("\n\n------------------------------------------------------------")
        print(f"The run folder is [{framework.running_folder}]")
